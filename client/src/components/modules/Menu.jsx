      ...
      {showMenu && (
        <div className="page-menu absolute right-0 mt-2 w-40 bg-gray-800 text-white rounded shadow-lg z-10 transition duration-300">
          <button
            ...
            className="block w-full px-4 py-2 text-middle rounded hover:bg-gray-600"
          >
            About Us
          </button>
          <button
            onClick={() => navigateToPage("/tips-and-tricks")}
            className="block w-full px-4 py-2 border-t border-b text-middle hover:bg-gray-600"
          >
            Tips and Tricks
          </button>
          <button
            onClick={() => navigateToPage("/blog")}
            className="block w-full px-4 py-2 text-middle border-b hover:bg-gray-600"
          >
            Blog
          </button>
          <button
