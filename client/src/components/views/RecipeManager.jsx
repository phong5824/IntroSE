...
import { handleGetRecipesUser,handleDeleteRecipes } from "../../action/userAction";
const Recipe = (recipe) => {
  ...
  return (
    ...
    <div className="bg-white rounded-lg shadow pl-10 h-64 grid grid-cols-4 w-2/3 items-center justify-center ">
      ...
      <div className="col-span-1 flex items-center justify-center ml-10 space-x-5">
        ...
        <button className="bg-white-300 hover:bg-yellow-300 text-white font-bold py-2 px-4 rounded"
