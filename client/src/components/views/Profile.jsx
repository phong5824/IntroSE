...
import NotiIcon from "/src/assets/notification.png";
import KeyIcon from "/src/assets/key.png";
import EditIcon from "/src/assets/edit.png";
import RecipeIcon from "/src/assets/cooking_profile.png";
import BlogIcon from "/src/assets/blogging.png";
import FavoriteIcon from "/src/assets/heart.png";
        ...
        <div className="sm:w-2/5 relative py-3 sm:max-w-xl sm:mx-auto flex items-center">
          ...
          <div className="relative px-5 bg-green-300 shadow-lg sm:rounded-3xl sm:p-20 mx-auto w-full border-none">
            <div className="max-w-md mx-auto">
              <div>
                <img className="h-36 w-36 rounded-full object-cover border-2 mx-auto" src="https://cdn.alongwalk.info/vn/wp-content/uploads/2022/10/31171151/300-hinh-nen-dien-thoai-cute-ngau-cuc-dep-duoc-tai-nhieu1667185911.jpg" alt="Mc Scofild" />
              </div>
              <div className="divide-y divide-gray-200">
                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7 text-center">
                  <h2 className="text-2xl leading-9 font-bold text-gray-900">{userProfile.name}</h2>
          ...
          <div className="max-w-md mx-auto">
            <div className="divide-y divide-gray-200">
              <div className="py-8 text-base text-center leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                <h2 className="text-2xl text-center leading-9 font-bold text-gray-900">Personal information</h2>
              ...
              <div className="flex flex-col items-center justify-center pt-6 text-base leading-6 sm:text-lg sm:leading-7">
                <div className="flex space-x-3 items-center justify-center mt-3">
                  ...
                  <button className=" bg-blue-300 text-gray-800 rounded-full hover:font-semibold hover:bg-blue-400 px-4 py-1.5 w-full sm:w-auto">
