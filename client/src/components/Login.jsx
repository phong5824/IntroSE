  ...
  <div className="login-container flex relative flex-col items-center justify-around w-[400px] h-[390px] bg-green-200 border border-blue-700 rounded-lg shadow-lg">
    ...
    <div className="login-form w-[300px]" >
      <form className="flex flex-col justify-around w-full" onSubmit={onSubmit}>
        <label htmlFor="email" className="text-blue-700 mb-1 w-full font-bold">Email</label>
        <input
          type="text"
          name="email"
          onChange={(e) => {
        ...
        />
        <label htmlFor="password" className="text-blue-700 mb-1 font-bold">Password</label>
        <input
          type="password"
          name="password"
          onChange={(e) => {
          ...
          style={{ backgroundColor: "lightblue" }}
        />
        <button type="submit" className="btn bg-gray-900 w-full text-white py-2 rounded-md">
          Login
        </button>
        <Link to="/register" className="btn text-gray-700 hover:text-gray-900 mt-2">
          Register
        </Link>
      </form>
    </div>
